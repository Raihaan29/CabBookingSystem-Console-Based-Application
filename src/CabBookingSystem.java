...
public class CabBookingSystem {
    ...
    static int calculateFare(int distance, String cabType) {
        ...
        return switch (cabType.toLowerCase()) {


            case "sedan" -> distance * 45;
            case "suv" -> distance * 30;
            case "mini" -> distance * 25;
            default -> distance * 20;
    ...
    static void userDashboard(String phone) {
        ...
        while (true) {
            ...
            switch (ch) {
                case "1" -> bookCab(phone);

                case "2" -> users.get(phone).rides.forEach(System.out::println);
    ...
    static void adminDashboard() {
        while (true) {
            ...
            System.out.print("Enter choice: ");
            switch (sc.nextLine()) {
                case "1" -> rides.forEach(System.out::println);
    ...
    static void manageDrivers() {
        while (true) {
            ...
            switch (ch) {
                ...
                case "4" -> drivers.forEach(System.out::println);
                case "5" -> { return; }
                default -> System.out.println("Invalid");
            }
        }
